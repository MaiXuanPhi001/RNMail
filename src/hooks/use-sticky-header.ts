...
import { event, interpolate, useAnimatedScrollHandler, useAnimatedStyle, useSharedValue } from "react-native-reanimated"
...
export default function useStickyHeader() {
    ...
    const handleScroll = useAnimatedScrollHandler({
        onBeginDrag: event => {
            ...
            console.log('anchorY.value onBeginDrag: ', anchorY.value)
        },
        onScroll: event => {
